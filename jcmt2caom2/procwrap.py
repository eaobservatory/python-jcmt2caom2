...
#************************************************************************
#*
#*   Script Name:    procrecipe
#*
#*   Purpose:
#*    Scan the data_proc tables for ecipe instances for the JCMT that can be 
#*    ingested.  These must use the jcmtwrapdr script and have state="Y".
#*
#+ Usage: procrecipe [options] [identity_instance id ...]
#+
#+ Options:
